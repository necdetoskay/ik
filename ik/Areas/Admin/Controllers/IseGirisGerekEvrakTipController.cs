...
namespace ik.Areas.Admin.Controllers
{
    ...
    public class IseGirisGerekEvrakTipController : Controller
    {
        ...
        // GET: Admin/IseGirisGerekEvrakTip
        public async Task<ActionResult> Index()
        {
            return View(await db.Ozluk_IseGirisGerekEvrakTip.ToListAsync());
        }

        // GET: Admin/IseGirisGerekEvrakTip/Details/5
        ...
        // GET: Admin/IseGirisGerekEvrakTip/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: Admin/IseGirisGerekEvrakTip/Create
        ...
        // GET: Admin/IseGirisGerekEvrakTip/Edit/5
        ...
        // POST: Admin/IseGirisGerekEvrakTip/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: Admin/IseGirisGerekEvrakTip/Delete/5
        ...
        // POST: Admin/IseGirisGerekEvrakTip/Delete/5
