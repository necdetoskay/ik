...
namespace ik.Areas.Admin.Controllers
{
    ...
    public class EnumController : Controller
    {
        ...
        // GET: Admin/Enum/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: Admin/Enum/Create
